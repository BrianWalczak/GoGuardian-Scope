...
if(document.getElementById("scriptSelect").value != "none") {
	...
	if(document.getElementById("scriptSelect").value == "enableExtension") {
		document.getElementById('code').value = 'var extensionId = "" //Please enter the ID of the extension. You can find it by going to chrome://extensions, clicking on the "Details" button under the extension, and finding the ID in the address bar \n\nchrome.management.setEnabled(extensionId, true)'
	}
